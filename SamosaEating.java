...
box-i and box-j, where  samosas[i] <= samosas[j].
	...
	If samosas[i] != samosas[j] , then eat all samosas from box-i, 	and from 
	box-j eat only samosas[i] samosas, and left with ( samosas[j]-samosas[i] ) 
...
import java.util.*;
public class SamosaEating{
    static int betterLeft(int arr[]){
    ...
    public static void main (String[] args) {
        ...
        System.out.println(betterLeft(arr));
